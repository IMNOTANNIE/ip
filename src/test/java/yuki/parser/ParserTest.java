...
class ParserTest {
    ...
    void parse_taskCreationMissingRequiredParts_exceptionThrown() {
        assertAll(
                () -> assertThrows(YukiException.class, () -> Parser.parse("todo")),
    ...
    void parse_numberedCommandWithoutValidNumber_exceptionThrown() {
        assertAll(
                () -> assertThrows(YukiException.class, () -> Parser.parse("mark")),
    ...
    void parse_noArgumentCommandWithExtraText_exceptionThrown() {
        assertAll(
                () -> assertThrows(YukiException.class, () -> Parser.parse("list now")),
